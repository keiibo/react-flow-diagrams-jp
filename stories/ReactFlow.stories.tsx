  ...
  args: {
    nodes: [
      ...
      },
      {
        ...
        type: "image",
        data: {
          imageUrl: "https://picsum.photos/id/10/150/150",
          label: "都市景観",
          objectFit: "cover",
          borderRadius: 15,
        } as IImageNodeData,
      ...
      },
      {
        ...
        type: "image",
        data: {
          imageUrl: "https://picsum.photos/id/20/150/150",
          label: "プロフィール",
          objectFit: "cover",
          borderRadius: 75,
        } as IImageNodeData,
      ...
      },
      {
        ...
        type: "image",
        data: {
          imageUrl: "https://picsum.photos/id/30/150/150",
          label: "アート作品",
          objectFit: "cover",
          opacity: 0.8,
        } as IImageNodeData,
    ...
    nodes: [
      {
        ...
        type: "image",
        data: {
          imageUrl: "https://picsum.photos/id/100/150/150",
          label: "正常な画像",
        } as IImageNodeData,
        width: 150,
        height: 150,
      ...
      },
      {
        ...
        type: "image",
        data: {
          imageUrl: "https://picsum.photos/id/200/150/150",
          label: "リロード画像",
        } as IImageNodeData,
        width: 150,
        height: 150,
...
export const ImageCustomization: Story = {
  args: {
    nodes: [
      {
        id: "square",
        ...
        type: "image",
        data: {
          imageUrl: "https://picsum.photos/id/300/130/130",
          label: "正方形",
          objectFit: "cover",
          borderRadius: 0,
        } as IImageNodeData,
      ...
      },
      {
        ...
        type: "image",
        data: {
          imageUrl: "https://picsum.photos/id/310/130/130",
          label: "角丸",
          objectFit: "cover",
          borderRadius: 20,
        } as IImageNodeData,
      ...
      },
      {
        ...
        type: "image",
        data: {
          imageUrl: "https://picsum.photos/id/320/130/130",
          label: "円形",
          objectFit: "cover",
          borderRadius: 65,
        } as IImageNodeData,
      ...
      },
      {
        ...
        type: "image",
        data: {
          imageUrl: "https://picsum.photos/id/400/100/130",
          label: "contain",
          objectFit: "contain",
        } as IImageNodeData,
        width: 130,
      ...
      },
      {
        ...
        type: "image",
        data: {
          imageUrl: "https://picsum.photos/id/410/100/130",
          label: "cover",
          objectFit: "cover",
        } as IImageNodeData,
        width: 130,
      ...
      },
      {
        ...
        type: "image",
        data: {
          imageUrl: "https://picsum.photos/id/420/100/130",
          label: "fill",
          objectFit: "fill",
        } as IImageNodeData,
        width: 130,
